...
public class mulitset{
    ...
    public static void main(String[] args) {
        ...
        //code here
        //a lil bit out of practise no doubt, but I have to figure something out for sure
        int test = sc.nextInt();
        while(test --> 0){
            int n = sc.nextInt();
            int[] a = new int[n];
            ...
            //a[i] and b[i] are pretty huge for sure
            Map<Integer, Integer> count = new HashMap<>();  //keeping the count baby
            for(int i = 0; i < n; i++){
                int num = a[i];
                while(num % 2 == 0){
                    num = num/2;
