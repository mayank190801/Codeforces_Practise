...
public class monoblock{
    ...
    public static void main(String[] args) {
        ...
        //now we have total, but we gotta subtract some no
        for(int i= 1; i < n; i++){
            if(arr[i-1] == arr[i]){
                long red = (long) i * (n - i);
                total -= red;
...
//        out.println(total);
        ...
        //now solve for the queries and print the answer
        ...
        for(int i= 0; i < m; i++){
            ...
            //1 2 3 4 5
            if(pos > 1){
                boolean bsame = arr[pos - 1] == arr[pos - 2];
                boolean asame = arr[pos - 2] == val;

                if(bsame != asame){
                    if(bsame){ //increment
                        total += (long) (pos-1) * (n - pos + 1);
                    }else{  //decrement
                        total -= (long) (pos-1) * (n - pos + 1);
                    }
                }
            ...
            //check right
            //1 2 3 4 5
//            out.println(total);tota
            if(pos < n){
                boolean bsame = arr[pos] == arr[pos - 1];
                boolean asame = arr[pos] == val;

                if(bsame != asame){
                    if(bsame){ //increment
                        total += (long)  (pos) * (n - pos);
                    }else{  //decrement
                        total -= (long) (pos) * (n - pos);
                    }
                }
...
//            out.println(total);
            ...
            ans.add(total);
            arr[pos - 1] = val;  //make the desired changes for sure
        }
