...
public class nature{
    ...
    public static void main(String[] args) {
        ...
        while(test--> 0){
            ...
            for(int i = 1; i < n; i++){
                //simply take the right most element
                long rright = arr[i] - cright;

                if(cleft == rright) continue;
                if(cleft > rright){
                    ans += abs(cleft - rright);
                    cleft = rright;
                }else{
                    ans += abs(cleft - rright);
                    cright += abs(cleft - rright);
                }

            }

            out.println(ans + abs(cleft));
        }
