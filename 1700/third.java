...
public class third{
    ...
    public static void main(String[] args) {
        ...
        while(test--> 0){
            ...
            long ans = 1;
            long left = Math.min(pos[0], pos[1]);
            long right = Math.max(pos[0], pos[1]);

            long count = abs(left - right) - 1;
            ...
            for(int i = 2; i < n; i++){
                ...
                if(cpos > left && cpos < right) {
                    ...
                    //only increment or decrement in the count
                    if(cpos < left){
                        count += abs(cpos - left) - 1;
                        left = cpos;
                    } else{
                        count += abs(cpos - right) - 1;
                        right = cpos;
                    }
