...
public class shiftingString{
    ...
    public static void main(String[] args) {
        ...
        while(test --> 0){
            ...
            //pretty sexy now
            //now solve it for 1 or 2 or 3 movements for sure no?
            ArrayList<Long> times = new ArrayList<>();
            for(String temp : cycles){
            ...
            //now taking the hcf of the numbers to find the answer
            long ans = 1L;
            for(long num : times){
                ans = lcm(ans, num);
            }
