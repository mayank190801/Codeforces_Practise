...
public class railway{
    ...
    public static void main(String[] args) {
        ...
        //this is pretty simple for sure, now figure this out
        //ask for the values of all m queries
        ArrayList<Pair> valEdge = new ArrayList<>();
        ...
        for(int i= 0; i < m; i++){
            ...
            int val = sc.nextInt();
            valEdge.add(new Pair(i, val));
            values.put(i, val);
            sb.setCharAt(i, '0');
        }

        //using the above code, I would have values for all the edges for sure
        Collections.sort(valEdge, (a,b) -> a.b - b.b);
//        System.out.println(valEdge);valEdge

        //now I have to see something imp
        int prev = 0;
        for(int i = 0; i < m; i++){
            Pair p = valEdge.get(i);
            int val = p.b;
            int idx = p.a;
            sb.setCharAt(idx, '1');
            String curr = sb.toString();
